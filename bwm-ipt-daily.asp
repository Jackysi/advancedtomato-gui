...
<content>
	...
	<div id="cstats" class="box">
		<div class="heading">Daily IP Traffic <a class="pull-right" href="#" data-toggle="tooltip" title="Reload Information" onclick="loadPage('#bwm-ipt-daily'); return false;"><i class="icon-reboot"></i></a></div>
		<div class="content">
