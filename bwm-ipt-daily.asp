...
<content>
	...
	<div id="cstats" class="box">
		<div class="heading">Daily IP Traffic <a class="pull-right" href="#" data-container="body" data-toggle="tooltip" title="Reload Information" onclick="reloadPage(); return false;"><i class="icon-reboot"></i></a></div>
		<div class="content">
