	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="fluid-gr" id="mounties">
			<script type="text/javascript">
				...
				var cifs = '<div class="box"><div class="heading"><i class="icon-drive"></i> CIFS1 <small>(/cifs1)</small></div><div class="content">' +
				createFormFields([
				...
				cifs += '<div class="box"><div class="heading"><i class="icon-drive"></i> CIFS2 <small>(/cifs2)</small></div><div class="content">' +
				createFormFields([
