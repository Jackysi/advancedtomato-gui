			...
			for (var uidx = 0; uidx < wl_ifaces.length; ++uidx) {
				...
				if (wl_sunit(uidx)<0) {
					...
					f = [
						...
						{ title: 'Channel', name: 'wl'+u+'_channel', type: 'select', options: ghz[uidx], prefix: '<div class="pull-left" id="__wl'+u+'_channel">', suffix: '</div> &nbsp; <button class="btn btn-primary" type="button" id="_f_wl'+u+'_scan" value="Scan" onclick="scanButton('+u+')">Scan</button> &nbsp; <div class="spinner" style="visibility: hidden;" id="spin'+u+'"></div>',
						...
						{ title: 'Shared Key', indent: 2, name: 'wl'+u+'_wpa_psk', type: 'password', maxlen: 64, size: 59, peekaboo: 1,
