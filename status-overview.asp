...
<html lang="en">
	<head>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				$('#gui-version').html('<i class="icon-info-alt"></i> ' + gui_version + '');
	...
	<body>
		<div id="wrapper">
			...
			<div class="content"><div class="ajaxwrap"></div><div class="clearfix"></div></div>
		</div>
	</body>
</html>