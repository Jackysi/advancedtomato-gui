...
<content>
	...
	<div id="rstats" class="box">
		<div class="heading">Weekly Bandwidth <a class="pull-right" href="#" data-toggle="tooltip" title="Reload Information" onclick="loadPage('bwm-weekly.asp'); return false;"><i class="icon-reboot"></i></a></div>
		<div class="content">
