...
<content>
	...
	<div id="cstats" class="box">
		<div class="heading">Monthly IP Traffic <a class="pull-right" href="#" data-toggle="tooltip" data-container="body" title="Reload Information" onclick="reloadPage(); return false;"><i class="icon-reboot"></i></a></div>
		<div class="content">
