...
<content>
	...
	<div id="cstats" class="box">
		<div class="heading">Monthly IP Traffic <a class="pull-right" href="#" data-toggle="tooltip" title="Reload Information" onclick="loadPage('bwm-ipt-monthly.asp'); return false;"><i class="icon-reboot"></i></a></div>
		<div class="content">
