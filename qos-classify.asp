		...
		qosg.setup = function() {
			...
			this.init('qg', 'move', 80, [
				{ multi: [
					...
					{ type: 'text', prefix: '<div class="erow y5"><div class="xa">KB Transferred</div><div class="xb">', suffix: '</div>' },		/* KB Transferred moved to first column by Ratatosk */
					{ type: 'text', prefix: '<div class="xc">-</div><div class="xd">', suffix: '</div></div>' }
				] },
				{ type: 'select', options: class1, vtop: 1 },
				{ type: 'text', maxlen: 32, vtop: 1 },
				{ type: 'custom', custom:'<span></span>', vtop: 1 }		/* Ratatosk BV, added an empty column for the border above the editorfield */ 
			]);
